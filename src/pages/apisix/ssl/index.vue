<template>
  <div>
    <t-card class="title-card" :bordered="false" :title="t('pages.apisixSsl.title')">
      <p>{{ t('pages.apisixSsl.description') }}</p>
    </t-card>
    ...
    <t-card class="table-card-container" :bordered="false">
      <t-row class="operation-container" justify="space-between">
        <div class="operation-container-left">
          <t-button @click="opOnClickRefresh"> {{ t('pages.apisixSsl.operations.refresh') }} </t-button>
        ...
        <div class="operation-container-right">
          <t-input
            ...
            class="search-input"
            :placeholder="t('pages.apisixSsl.placeholder')"
            clearable
          >
